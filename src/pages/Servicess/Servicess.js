...
const points = {
  left: [
    ...
    },
    {
      ...
      subline: 'Provision and manage secure, scalable VMs, virtual networks, firewalls, storage, and governance frameworks—built for performance and resilience'
    },
    {
      title: 'PaaS (Platform as a Service)',
      subline: 'Deploy apps and services faster with Azure App Services, Azure Functions, AKS (Kubernetes), and fully managed databases. We modernize legacy code into cloud-native stacks'
    },
    {
      title: 'DevOps on Azure',
      subline: 'CI/CD pipelines, GitHub Actions, Azure DevOps, infrastructure as code (Terraform/ARM/Bicep), automated testing—we bring speed and control to software delivery.'
    }
  ],
  right: [
    {
      title: 'Lift-and-Shift Migrations',
      subline: 'We move legacy workloads to Azure with zero data loss and minimal disruption. Proven migration blueprints for VMs, apps, databases, and even SAP.'
    },
    {
      title: 'Hybrid Cloud Deployments',
      subline: 'Extend your datacenter to Azure using Azure Arc, ExpressRoute, and site-to-site VPNs. Keep critical workloads on-prem while unlocking cloud elasticity.'
    },
    {
      title: 'Backup & Disaster Recovery (DR)',
      subline: 'Protect what matters with Azure Site Recovery, Geo-redundant storage, and automated failover strategies—fully tested and cost-optimized.'
    },
    {
      title: 'Greenfield Cloud Projects',
      subline: 'Starting from scratch? We build clean-slate cloud environments with zero technical debt, secured from day one, with CI/CD, monitoring, and automation baked in.'
    }
  ]
};
const services = [
     ...
     <ServiceDescription
      ...
      <div className="itservices-section">
        <div className="section-title">
          ...
          <h2>Transforming Businesses with <br />Advanced IT Solutions</h2>
        </div>
        <Swiper
        ...
        >
          {services.map((service, idx) => (            <SwiperSlide
              key={idx}
              style={{
